...
#define	VER_PRODUCTNAME				"Shockwave Multiuser Server Database Object Xtra"
...
#define	VER_MAJORVERSION			 3
#define	VER_MAJORVERSION_STRING		"3"
...
#define	VER_COMPONENTNAME			"Database Objects Xtra"

#ifdef	WIN16
	#error There is no Win16 build !
#else
	#define	VER_WINFILENAME			"DBObject.x32"
	#define	VER_MINMODULENAME		"DatabaseObjects"
#endif
