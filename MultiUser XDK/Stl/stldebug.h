...
//============================================================================
// das - changed this to avoid inlining so I can set breakpoints
...
//das inline void __stl_error_report(const char* file, int line, 
//das                                const char* diagnostic) {
//das     fprintf(stderr, "%s:%d STL error : %s\n", file, line, diagnostic); 
//das }
extern void __stl_error_report(const char* file, int line, const char* diagnostic );
